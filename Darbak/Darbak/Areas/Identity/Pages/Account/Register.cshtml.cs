...
public class RegisterModel : PageModel
{
        ...
        string? returnUrl = null)
    {
        ...
        // Every normal customer account must receive
        // the User role before sign-in.
        var roleResult =
        ...
        {
            // Do not leave an account in the database
            // without the expected role.
            var cleanupResult =
            ...
            {
                _logger.LogError(
                    "Failed to clean up user {UserId} after role assignment failure.",
                    user.Id);
            }
