...
public class ExternalLoginModel : PageModel
{
    ...
    private readonly ILogger<ExternalLoginModel>
        _logger;
            ...
            string? returnUrl = null)
    {
        ...
        // External users must receive the same
        // default role as normal registrations.
        var roleResult =
            await _userManager
                .AddToRoleAsync(
                    user,
        ...
        {
            await CleanupNewUserAsync(user);
    ...
    private async Task CleanupNewUserAsync(
        ApplicationUser user)
    {
        ...
        {
            _logger.LogError(
                "Failed to clean up user {UserId} after external registration failure.",
                user.Id);
        }
    }
